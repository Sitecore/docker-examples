...
try {
    ...
    .\mkcert.exe -cert-file xp0cm.localhost.crt -key-file xp0cm.localhost.key "xp0cm.localhost"
    .\mkcert.exe -cert-file xp0id.localhost.crt -key-file xp0id.localhost.key "xp0id.localhost"
}
catch {
